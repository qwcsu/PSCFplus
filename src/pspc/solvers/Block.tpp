   ...
   */
   ...
   {   
      ...
      for (i = 0; i < r; ++i) {
         ...
         // std::cout<< "stress_[i] = " << stress_[i]<<std::endl;
      }   
   ...
   */
   ...
   void Block<D>::step(const QField& q, QField& qNew)
   {
      ...
      for (i = 0; i < nx; ++i) {
         ...
         // std::cout << qr_[i] << " = " << q[i] << " * " << expW_[i] << "\n";
         // std::cout << qr2_[i] << " = " << q[i] << " * " << expW2_[i] << "\n";
         // std::cout << "\n";
      }
