...
namespace Pscf
{
    ...
    */
    ...
    void PolymerTmpl<Block>::solve()
    {
        ...
        // double q2= block(1).propagator(0).computeQ();
        // double q3= block(2).propagator(0).computeQ();
        #include <iomanip> 
        std::cout << std::setprecision(13) << "Q = " <<  q <<std::endl;
        // std::cout << std::setprecision(13) << "Q2= " <<  q2<<std::endl;
        // std::cout << std::setprecision(13) << "Q3= " <<  q3<<std::endl;
