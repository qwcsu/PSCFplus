    ...
    namespace Pspg
    {
        ...
        public:
            ...
            */
            ...
            WField& wFieldRGridPh(int monomerId);
             ...
             * \param monomerId integer monomer type index
             */
            RDField<D>& wFieldKGrid(int monomerId);
        ...
        private:
            ...
            */
             ...
             *
             */
            DArray<RDField<D> > wFieldsKGrid_;
            ...
            DArray<WField> cFieldsRGrid_ph_;
...
// #endif
        ...
        template <int D>
        inline
        DArray< typename System<D>::WField >& System<D>::wFieldsRGridPh()
        {
        ...
        template <int D>
        inline
        typename System<D>::WField& System<D>::wFieldRGridPh(int id)
        {
        ...
        template <int D>
        inline
        DArray<RDField<D> >& System<D>::wFieldsKGrid()
        {
        ...
        template <int D>
        inline
        RDField<D>& System<D>::wFieldKGrid(int id)
        {
        ...
        template <int D>
        inline
        DArray< typename System<D>::CField >& System<D>::cFieldsRGridPh()
        {
            return cFieldsRGrid_ph_;
        }
        ...
        template <int D>
        inline
        typename System<D>::CField& System<D>::cFieldRGridPh(int id)
        {
            return cFieldsRGrid_ph_[id];
        }
